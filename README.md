...
* фото (аватарка)
* информация о всех мероприятих ![image](https://user-images.githubusercontent.com/92600545/224554720-debfb1ec-26ab-4a75-abd3-45beccb862e1.png) в которых пользователь учавствует и которые он организовал (+ добавляет человека в мероприятие, - убирает)
